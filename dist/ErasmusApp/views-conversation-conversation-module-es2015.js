...
class Message {
    constructor(id, author, destination, text, timestamp, __v) {
        this._id = id;
        this.author = author;
...
let ConversationPage = class ConversationPage {
    constructor(route, chatService, storage) {
        this.route = route;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.chatService.getMessage().subscribe((data) => {
                this.messages.push(new _models_Message_message__WEBPACK_IMPORTED_MODULE_5__["Message"]('', data.email, this.name, data.message, new Date(), 0));
            });
        });
    }
    onEnter(value) {
