...
var ConversationPage = /** @class */ (function () {
    ...
    ConversationPage.prototype.sendMessage = function () {
        ...
        if (this.message.replace(/\s/g, '').length) {
            var pepe = this.messages.push(new _models_Message_message__WEBPACK_IMPORTED_MODULE_5__["Message"]('', this.user.email, this.name, this.message, new Date(), false, 0)); // TODO: Swap name email
            console.log(pepe);
