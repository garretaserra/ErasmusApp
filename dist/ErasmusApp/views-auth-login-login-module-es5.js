...
var UserLogin = /** @class */ (function () {
    ...
    UserLogin.ctorParameters = function () { return [
        null,
        null
    ]; };
    return UserLogin;
...
var LoginPage = /** @class */ (function () {
    function LoginPage(authService, userService, router, formBuilder, storage) {
    ...
    LoginPage.prototype.login = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.authService.login(new _models_User_userLogin__WEBPACK_IMPORTED_MODULE_5__["UserLogin"](this.loginForm.controls.email.value, this.loginForm.controls.password.value)).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var response;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                //Save info locally
                                _a.sent();
                                return [4 /*yield*/, this.storage.saveUser(JSON.stringify(this.user))];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, this.router.navigateByUrl('/home')];
                            case 3:
