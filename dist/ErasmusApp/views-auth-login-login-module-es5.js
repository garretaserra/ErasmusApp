...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-auth-login-login-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/views/auth/login/login.page.html":
  /*!****************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/auth/login/login.page.html ***!
    \****************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsAuthLoginLoginPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModelsUserUserLoginTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthLoginLoginRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthLoginLoginPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _models_User_userLogin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function LoginPage(authService, userService, toastController, router, formBuilder, storage) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    storageUser = this.storage.getUser(); //If user is present redirect to home
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    this.authService.login(new _models_User_userLogin__WEBPACK_IMPORTED_MODULE_5__["UserLogin"](this.loginForm.controls.email.value, this.loginForm.controls.password.value)).subscribe(function (res) {
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                ...
                                console.log(this.user); //Save info locally

                                _context3.next = 6;
                                return this.storage.saveToken(this.user.jwt);

                              case 6:
                                _context3.next = 8;
                                return this.storage.saveUser(JSON.stringify(this.user));
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/auth/login/login.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./login.page.scss */
      "./src/app/views/auth/login/login.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _models_User_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _storage_storage_component__WEBPACK_IMPORTED_MODULE_7__["StorageComponent"]])], LoginPage);
    /***/
  }
}]);
//# sourceMappingURL=views-auth-login-login-module-es5.js.map